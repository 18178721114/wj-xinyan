...
class Patient_vcode_v2 extends \Air\Libs\Controller
{
    ...
    public function run()
    {
        ...
        if ($this->is_fd16) {
            ...
            CheckLog::addLogInfo(0, 'patient_vcode_v2_fd16', ['data' => ['vcode' => $this->vcode, 'sn' => $camera['sn'], 'pcode' => $this->pcode]], ($camera['user_id'] ?? 0), '', $this->pcode);
